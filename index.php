                    ...
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex">
                                <div>
                                    <img src="assets/img/login/logo.jpg" class="align-content-center" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h4 class="text-dark mb-4">Bienvenid@!</h4>
                                    </div>
                                    <form class="user" id="formLogin">
                                        <div class="mb-3"><input id="usuario" class="form-control form-control-user" type="email" aria-describedby="emailHelp" placeholder="Email" name="usuario" /></div>
                                        <div class="mb-3"><input id="password" class="form-control form-control-user" type="password" placeholder="Contraseña" name="password" /></div>
                                        <div class="mb-3">
                                        ...
                                        <input class="btn btn-success text-light d-block btn-user w-100" type="submit" value="Iniciar sesión">
                                        <hr />
                                        <hr />
                                    </form>
